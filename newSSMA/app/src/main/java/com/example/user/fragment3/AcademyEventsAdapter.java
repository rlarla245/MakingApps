...
public class AcademyEventsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.academy_events_recyclerview, parent, false);
    ...
    private static class RowCell extends RecyclerView.ViewHolder {
        ...
        public RowCell(View view) {
            super(view);
            imageView = view.findViewById(R.id.academy_event_recyclerview_imageview);
        }
    }
}
