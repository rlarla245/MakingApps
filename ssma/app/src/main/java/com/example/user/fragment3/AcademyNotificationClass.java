...
public class AcademyNotificationClass extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.academy_notification_class);
        ...
        toolbar.findViewById(R.id.toolbar_email).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AcademyNotificationClass.this, "서버에 연결되지 않았습니다.", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (item.getItemId() == R.id.third_peoples) {
                    Toast.makeText(AcademyNotificationClass.this, "개발중입니다.", Toast.LENGTH_SHORT).show();
                }
        ...
        RecyclerView view = (RecyclerView)findViewById(R.id.notification_recyclerview);

        AcademyNotificationClassAdapter academyNotificationClassAdapter = new AcademyNotificationClassAdapter();
        view.setAdapter(academyNotificationClassAdapter);

        view.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(view.getContext(), AcademyNotificationFragment.class);
                startActivity(intent);
            }
        });
        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AcademyNotificationClass.this, "서버 연결이 필요합니다.", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
