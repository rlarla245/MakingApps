...
public class MyCardViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyCardViewAdapter() {
        cardViewDTOS.add(new CardViewDTO(R.drawable.i_1, "서지수", "안녕하세요~ 사막여우 서지수입니다!"));
        cardViewDTOS.add(new CardViewDTO(R.drawable.i_2, "서지수", "안녕하세요~ 사막여우 서지수입니다!"));
        cardViewDTOS.add(new CardViewDTO(R.drawable.i_3, "서지수", "안녕하세요~ 사막여우 서지수입니다!"));
        cardViewDTOS.add(new CardViewDTO(R.drawable.i_4, "서지수", "안녕하세요~ 사막여우 서지수입니다!"));
        cardViewDTOS.add(new CardViewDTO(R.drawable.i_5, "서지수", "안녕하세요~ 사막여우 서지수입니다!"));
    }
